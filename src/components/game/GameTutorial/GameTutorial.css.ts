...
export const wrapperRandom = style({
  position: "relative",
  flex: 1,
  display: "flex",
  flexDirection: "column",
...
export const scoringDotHard = style([
  scoringDotBase,
  { backgroundColor: vars.color.point_04 },
]);
export const scoringDotNormal = style([
  scoringDotBase,
  { backgroundColor: vars.color.point_03 },
]);
export const scoringDotEasy = style([
  scoringDotBase,
